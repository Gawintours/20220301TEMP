...
public class FileBrowser extends Page {
	public static final Logger log = LoggerFactory.getLogger(FileBrowser.class);
...
//			if (chk1.isSelected()) {
//				log.info("going dual panel mode");
//				switchToDualPaneMode();
//				App.getGlobalSettings().setDualPaneMode(true);
//			} else {
//				log.info("going single panel mode");
//				switchToSinglePanelMode();
...
//			log.info("Left drop down changed");
...
//			if (obj == fileBrowserView) {
//				ignoreEvent = true;
//				log.info("Remove local or foreign");

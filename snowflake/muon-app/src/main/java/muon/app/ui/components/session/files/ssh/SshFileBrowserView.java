...
public class SshFileBrowserView extends AbstractFileBrowserView {
	public static final Logger log = LoggerFactory.getLogger(SshFileBrowserView.class);
...
//				log.info("Foreign file drop");
//				sourceFs = this.fileBrowser.getFs(transferData.getSource());
//				log.info("Foreign sftp fs: " + sourceFs);
//			}

...
public class SshClient2 implements Closeable {
	public static final Logger log = LoggerFactory.getLogger(SshClient2.class);
...
//			log.info("allowedMethods4: " + allowedMethods
...
//			}
//
//			log.info("allowedMethods5: " + allowedMethods
//					+ " closed: " + closed.get() + " authenticated: "
//					+ authenticated.get());
//
//			if (closed.get()) {
...
//			}
//
//			log.info("allowedMethods6: " + allowedMethods
//					+ " closed: " + closed.get() + " authenticated: "
//					+ authenticated.get());
//
//			if (authenticated.get()) {

...
public class PlatformUtils {
	public static final Logger log = LoggerFactory.getLogger(PlatformUtils.class);
...
//			}
	...
	public static void openLinux(final File f) throws FileNotFoundException {
		...
		try {
			...
			log.error("openLinux file error:{}", e.getMessage(),e);
		}
	}
	...
	public static void openMac(final File f) throws FileNotFoundException {
		...
		try {
			...
			log.error("openMac file error:{}", e.getMessage(),e);
		}
	}
